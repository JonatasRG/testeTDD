...
class TestlerConta(TestCase):
    def test_transforma_subtracao_em_soma_de_negativo(self):
        conta_testada = lerConta("(4-1)(4-2)")
        conta_testada.transforma_subtracao_em_soma_de_negativo()
        self.assertEqual(conta_testada.conta, "(4+-1)(4+-2)")
